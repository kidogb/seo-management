...
const CreateForm = Form.create()(props => {
  ...
  return (
    ...
    >
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="Tên sản phẩm">
        {form.getFieldDecorator('desc', {
          rules: [{ required: true, message: 'Nhập tên sản phẩm ít nhất 5 kí tự', min: 5 }],
...
class UpdateForm extends PureComponent {
  ...
  renderContent = (currentStep, formVals) => {
    ...
    return [
      <FormItem key="name" {...this.formLayout} label="product_name">
        {form.getFieldDecorator('name', {
          rules: [{ required: true, message: 'Please enter a product name!!' }],
          initialValue: formVals.name,
        })(<Input placeholder="Input here" />)}
      </FormItem>,
      <FormItem key="desc" {...this.formLayout} label="product_description">
        {form.getFieldDecorator('desc', {
          rules: [{ required: true, message: 'Please enter a product description with at least 5 characters!!', min: 5 }],
          initialValue: formVals.desc,
        })(<TextArea rows={4} placeholder="Input at least 5 characters" />)}
      </FormItem>,
    ];
  };
...
class TableList extends PureComponent {
  ...
  columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <Fragment>
          <a onClick={() => this.handleUpdateModalVisible(true, record)}>Cập nhật</a>
